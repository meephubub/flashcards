...
export function StudyPageClient({ deckId }: { deckId: number }) {
  ...
  if (Number.isNaN(deckId)) {
    return (
      <div className="flex h-[100dvh] bg-white text-black">
        <SidebarProvider>
          <AppSidebar />
          <SidebarInset>
            <header className="sticky top-0 z-20 flex h-14 shrink-0 items-center border-b border-black/10 bg-white/70 backdrop-blur supports-[backdrop-filter]:bg-white/60">
